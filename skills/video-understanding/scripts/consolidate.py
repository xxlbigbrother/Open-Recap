...
def _index_cache_matches(work_dir, vlm_analysis):
    ...
    return (
        ...
        and meta.get('provider_settings') == CONFIG.get('understanding_provider_settings')
...
def consolidate_transcript(work_dir):
    ...
    if _fresh(out_path, work_dir / "asr_result.json"):
        ...
        if (
            ...
            and existing.get('provider_settings') == CONFIG.get('understanding_provider_settings')
