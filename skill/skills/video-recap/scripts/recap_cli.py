...
TTS_PROVIDERS = ("auto", "mimo-tts", "fish-audio", "doubao-tts")
...
def parse_args():
    ...
    parser.add_argument(
        "--film-title",
        default=None,
        help="film title for source-backed research after understanding and before writing",
    )
    parser.add_argument(
        "--film-year",
        type=int,
        default=None,
        help="optional release year used to disambiguate --film-title",
    )
    parser.add_argument(
        "--research-film",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="when --film-title is set, search film metadata after understanding (default on)",
    )
