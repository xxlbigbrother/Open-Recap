...
def build_edited_source_video(input_video, validated_plan, work_dir, output_path=None):
    ...
    source_map_path = work_dir / "original_source_map.json"
    if source_map_path.exists():
        from render_original import render_original
        render_original(validated_plan, work_dir, output_path, json.loads(source_map_path.read_text()))
