...
if os.environ.get("VIDEO_RECAP_PROVIDER") == "aihub-doubao":
    _understanding_provider = os.environ.get("UNDERSTANDING_PROVIDER", "aihub-gemini")
    if _understanding_provider == "aihub-gemini":
        from gemini_adapter import configure as _configure_understanding, chat as _understanding_chat
    elif _understanding_provider == "aihub-doubao":
        from aihub_adapter import configure as _configure_understanding, chat as _understanding_chat
    else:
        raise ValueError("UNDERSTANDING_PROVIDER must be aihub-gemini or aihub-doubao")
    _configure_understanding(CONFIG)
    api_call = _understanding_chat
    mimo_video_api_call = _understanding_chat
